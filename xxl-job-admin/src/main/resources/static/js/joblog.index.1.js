$(function() {
    ...
    var percentBar = function(pShape, cText, cBorder, cBar, cBack, vRound, bType) {
          ...
          return function(data, type, row) {
            if (data == null) {
                return I18n.system_empty;
            }
            console.log("status: " + data);
            s = parseFloat(data.toString().replace(/\s%|%/g,'')).toFixed(vRound);
	...
	setInterval(function() {
	    LogTable.ajax.url(base_url + '/joblog/statList').load(function(data) {console.log(data)}, false);
	}, 2 * 1000)
